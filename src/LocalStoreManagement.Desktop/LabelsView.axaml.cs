...
public partial class LabelsView : UserControl
{
    ...
    public LabelsView(ProductRepository productRepository)
        : this(productRepository, LabelPrinterFactory.Create())
    {
    }

    internal LabelsView(ProductRepository productRepository, ILabelPrinter labelPrinter)
    {
    ...
    public void FocusPrimaryField() => LabelSearchInput.Focus();
