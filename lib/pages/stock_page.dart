...
class StockPage extends StatefulWidget {
  const StockPage({super.key, required this.services});
        ...
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Expanded(
            child: Column(children: [
              TextField(controller: _search, onChanged: (_) => setState(() {}), decoration: const InputDecoration(border: OutlineInputBorder(), labelText: 'Cerca variante / SKU / barcode', prefixIcon: Icon(Icons.search))),
